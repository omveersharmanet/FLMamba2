...
from layers.Mamba2_EncDec import Encoder, EncoderLayer
...
class Model(nn.Module):
    ...
    def __init__(self, configs):
        ...
        mamba2_cfg = Mamba2Config(
            ...
            conv_kernel=2,      # small kernel works well for time-series
    ...
    def forecast(self, x_enc, x_mark_enc, x_dec, x_mark_dec):
        ...
        #print(x_enc[1,:,0])
        #print(x_enc[2,:,0])
        #print('x_enc, x_mark_enc, x_dec, x_mark_dec',x_enc.shape, x_mark_enc.shape, x_dec.shape, x_mark_dec.shape)
        # Embedding
    ...
    def forward(self, x_enc, x_mark_enc, x_dec, x_mark_dec, mask=None):
        ...
        #print('dec_out shape:',dec_out.shape,'dec_out[:, -self.pred_len:, :] shape:',dec_out[:, -self.pred_len:, :].shape)
