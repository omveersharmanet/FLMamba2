...
from data_provider.data_factory import one_data_provider
...
class Exp_Long_Term_Forecast_one_data(Exp_Basic):
    def __init__(self, args):
        super(Exp_Long_Term_Forecast_one_data, self).__init__(args)
    ...
    def _get_data(self, flag):
        data_set, data_loader = one_data_provider(self.args, flag)
